...
class CustomQunvNet(nn.Module):
    ...
    def __init__(self, input_size=8, shots=128):
        ...
        self.fc_size = (input_size - KERNEL_SIZE + 1) **2 * CONV_OUTPUT_SIZE
        self.conv = nn.Conv2d(1, CONV_OUTPUT_SIZE, kernel_size=KERNEL_SIZE)
...
#         self.conv2 = nn.Conv2d(16, CONV_OUTPUT_SIZE, kernel_size=KERNEL_SIZE)
#         self.fc1 = nn.Linear(self.fc_size, 64)
#         self.fc2 = nn.Linear(64, 2)
